...
AMRITA_OFFSET  = 0x3DDBB3 +9 
GOLD_OFFSET    = 0x3DDBC3 + 9
CONSTITUTION   = 0x3ADF63 + 0x2FD6A + 9
HEART          = 0x3ADF67 + 0x2FD6A + 9
STAMINA        = 0x3ADF6B + 0x2FD6a + 9
STRENGTH       = 0x3ADF6F + 0x2FD6A + 9
SKILL          = 0x3ADF73+ 0x2FD6A  + 9
INTELLECT      = 0x3ADF77 + 0x2FD6A+ 9
MAGIC          = 0x3ADF7B + 0x2FD6A+9 
